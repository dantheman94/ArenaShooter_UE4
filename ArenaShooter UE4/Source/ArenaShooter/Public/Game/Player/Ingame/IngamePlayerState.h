...
protected:
	...
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Replicated)
		TSubclassOf<class AWeapon> _StartingPrimaryWeapon = NULL;

	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Replicated)
		TSubclassOf<class AWeapon> _StartingSecondaryWeapon = NULL;

	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Replicated)
		TSubclassOf<class AWeapon> _StartingReserveWeapon = NULL;
...
public:
	...
	*/
	UFUNCTION(Server, Reliable, WithValidation, BlueprintCallable)
		void Server_Reliable_SetStartingPrimaryWeapon(TSubclassOf<AWeapon> StartingPrimaryWeapon);
	...
	*/
	UFUNCTION(Server, Reliable, WithValidation, BlueprintCallable)
		void Server_Reliable_SetStartingSecondaryWeapon(TSubclassOf<AWeapon> StartingSecondaryWeapon);
	...
	*/
	UFUNCTION(Server, Reliable, WithValidation, BlueprintCallable)
		void Server_Reliable_SetStartingReserveWeapon(TSubclassOf<AWeapon> StartingReserveWeapon);
