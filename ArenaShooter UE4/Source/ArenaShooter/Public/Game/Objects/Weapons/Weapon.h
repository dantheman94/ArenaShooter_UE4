...
protected:
	...
	*/
	UPROPERTY(BlueprintReadOnly, EditDefaultsOnly, Category = "Animation")
		TSubclassOf<UAnimInstance> _AnimationBPFirstPersonArms = NULL;
...
public:
	...
	*/
	...
	void SetNewOwner(APawn* NewOwner);
	...
	*/
	...
	void SetOwnersPrimaryWeapon(bool IsPrimaryWeapon);
	...
	*/
	...
	void SetOwnersSecondaryWeapon(bool IsSecondaryWeapon);

	/*
	*
	*/
	UFUNCTION(BlueprintPure) bool GetIsAiming() const { return _bIsPawnOwnerAiming; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) APawn* GetPawnOwner() { return _PawnOwner; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) bool IsOwnersPrimaryWeapon() const { return _bIsPawnOwnersPrimaryWeapon; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) bool IsOwnersSecondaryWeapon() const { return _bIsPawnOwnersSecondaryWeapon; }
	
	/*
	*
	*/
	UFUNCTION(BlueprintPure) int GetFireModeIterator() const { return _iFiringModeIterator; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) TArray<UFireMode*> GetFireModes() { return _uFiringModes; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) UFireMode* GetCurrentFireMode() const { return _uFiringModes[_iFiringModeIterator]; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) bool IsThereValidFireModeCount() const { return _uFiringModes.Num() >= 1 && _uFiringModes.Num() >= _iFiringModeIterator; }
	
	/*
	*
	*/
	UFUNCTION() TArray<UAmmo*> GetAmmoPool() { return _pAmmoPools; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) bool CanBeDuelWielded() const { return _bCanBeDuelWielded; }
	...
	* @return:	UAnimMontage*
	*/
	UFUNCTION() UAnimMontage* GetArmAnimation(E_HandAnimation AnimationEnum);
	...
	* @return:	UAnimMontage*
	*/
	UFUNCTION() UAnimMontage* GetGunAnimation(E_GunAnimation AnimationEnum);

	/*
	*
	*/
	UFUNCTION(BlueprintPure) FTransform GetTransformOriginArms() const { return _tOriginArms; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) FTransform GetTransformOriginWeapon() const { return _tOriginWeapon; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) TSubclassOf<UAnimInstance> GetAnimInstanceFirstPersonHands() const { return _AnimationBPFirstPersonArms; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) TSubclassOf<UAnimInstance> GetAnimInstanceFirstPersonGun() const { return _AnimationBPFirstPersonWeapon; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) TSubclassOf<UAnimInstance> GetAnimInstanceThirdPersonCharacter() const { return _AnimationBPThirdPersonCharacter; }
	...
	*
	*/
	UFUNCTION(BlueprintPure) FTransform GetOriginHands() const { return _tOriginArms; }
	...
	*
	*/
	UFUNCTION(BlueprintGetter) bool IsScopeAttachmentEnabled() const { return _bScopeEnabled; }

	/*
	*
	*/
	UFUNCTION(BlueprintGetter) UStaticMesh* GetSightMesh() { return _uScopeMesh; }

	/*
	*
	*/
	UFUNCTION(BlueprintGetter) FName GetSightAttachmentName() const { return _ScopeAttachmentSocket; }
	...
	*
	*/
	UFUNCTION(BlueprintGetter) FName GetFlashlightAttachmentName() const { return _FlashlightAttachmentSocket; }
	...
	*
	*/
	UFUNCTION(BlueprintPure) float GetDuelWieldingReloadTime() const { return _fDuelWieldingReloadTime; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) FTransform GetTransformOriginDuelPrimaryArms() const { return _tDuelOriginPrimaryArms; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) FTransform GetTransformOriginDuelSecondaryArms() const { return _tDuelOriginSecondaryArms; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) FTransform GetTransformOriginDuelPrimaryWeapon() const { return _tDuelOriginPrimaryWeapon; }

	/*
	*
	*/
	UFUNCTION(BlueprintPure) FTransform GetTransformOriginDuelSecondaryWeapon() const { return _tDuelOriginSecondaryWeapon; }
