...
protected:
	...
	*/
	UPROPERTY(BlueprintReadOnly, VisibleInstanceOnly, Category = "Inventory | Weapon | Reserve", Replicated)
...
public:
	...
	*/
	UFUNCTION(BlueprintPure)
		E_GrenadeType GetCurrentGrenadeType() { return _eCurrentGrenadeType; }
