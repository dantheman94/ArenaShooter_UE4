...
#include "InteractableBoxComponent.h"
...
UInteractableBoxComponent::UInteractableBoxComponent()
{
	...
	this->OnComponentBeginOverlap.AddDynamic(this, &UInteractableBoxComponent::OnOverlapBegin);
	this->OnComponentEndOverlap.AddDynamic(this, &UInteractableBoxComponent::OnOverlapEnd);
...
/*
	Called every frame
*/
void UInteractableBoxComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UInteractableBoxComponent::OnOverlapBegin(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void UInteractableBoxComponent::OnOverlapEnd(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	// Sanity checks
	if (_InteractionData == NULL)
		return;
...
void UInteractableBoxComponent::OnOverlapStay(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	// Don't proceed unless we are allowed to be interacted with
	if (_InteractionData == NULL)
		return;
